...
public class SingleResult {
	public static void main(String[] args) {
		...
		createGroup(identityService, UUID.randomUUID().toString(), "经理组A");
		// 查询group
		Group groupB = identityService.createGroupQuery().groupName("经理组B").singleResult();
		System.out.println(groupB.getId() + ":" + groupB.getName());
		Group groupA = identityService.createGroupQuery().groupName("经理A").singleResult();
		System.out.println(groupA.getId() + ":" + groupA.getName());
